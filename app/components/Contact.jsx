...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "16f1d263-ab3f-4205-84e7-4b76ba3b2876");
  ...
  return (
    ...
    <div id="contact" className='w-full px-[12%] py-10 scroll mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto]'>
      <h4 className='text-center mb-2 text-lg font-Ovo'>Connect withe Me</h4>
      <h2 className='text-center text-5xl font-Ovo'>Get In Touch</h2>

      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        I would love to hear from you. If you have any questions, comments o feedback, please use the form below.</p>
